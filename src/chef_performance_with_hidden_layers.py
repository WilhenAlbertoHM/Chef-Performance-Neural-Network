...
# 20 input units, batch normalization layer, 12 neurons in between, 
# dropout layer, and 4 output
...
# Train model with 200 epochs and a batch size of 32.
num_epochs = 200
batch_size = 32
model.fit(x_train, y_train_scaled, epochs=num_epochs, batch_size=batch_size)
...
print("Activation function used: relu and tanh")
